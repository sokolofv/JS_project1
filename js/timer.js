...
const updateTimer = () => {
    ...
    daysBlock.nextElementSibling.textContent = numWord(hours, ['день', 'дня', 'дней'])
    ...
    if (timeRemaining <= 0) {
        ...
        daysBlock.parentElement.classList.add('timer__item--expired');
        hoursBlock.parentElement.classList.add('timer__item--expired');
        minutesBlock.parentElement.classList.add('timer__item--expired');
        secondsBlock.parentElement.classList.add('timer__item--expired');
    }
}
